...
{
    public class RegistroOperacionesService : IHostedService
    {
        ...
        public RegistroOperacionesService(IServiceProvider serviceProvider, IWebHostEnvironment env)
        {
        ...
        private async void EscribirDatos(object state)
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<AdaptatechContext>();
        ...
        private async Task<List<Operacione>> ObtenerOperacionesDelDia(AdaptatechContext context)
        {
